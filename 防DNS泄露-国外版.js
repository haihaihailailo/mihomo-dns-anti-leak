...
const ENVIRONMENT = {
  ...
  "dns": {
    ...
    "fallback-filter": {
      ...
      // 配置说明：参与当前 DNS 结果筛选的 IP 网段。
      "ipcidr": [],
      // 配置说明：参与当前 DNS 筛选的域名条件。
      "domain": [],
      // 配置说明：参与当前 DNS 筛选的域名集合。
      "geosite": []
    },
    // 配置说明：为直连目标提供解析器。
    "direct-nameserver": [
    ...
    "nameserver-policy": {
      ...
      // 配置说明：精确域名 perplexity.ai 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "perplexity.ai": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 perplexity.ai 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".perplexity.ai": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 perplexity.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "perplexity.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 perplexity.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".perplexity.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 pplx.ai 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "pplx.ai": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 pplx.ai 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".pplx.ai": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 ppl-ai-file-upload.s3.amazonaws.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "ppl-ai-file-upload.s3.amazonaws.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 pplx-res.cloudinary.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "pplx-res.cloudinary.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 cursor-cdn.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "cursor-cdn.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 cursor-cdn.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".cursor-cdn.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 cursor.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "cursor.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 cursor.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".cursor.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 cursor.sh 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "cursor.sh": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 cursor.sh 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".cursor.sh": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 cursorapi.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "cursorapi.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 cursorapi.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".cursorapi.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 codeium.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "codeium.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 codeium.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".codeium.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 codeiumdata.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "codeiumdata.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 codeiumdata.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".codeiumdata.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 windsurf.build 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "windsurf.build": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 windsurf.build 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".windsurf.build": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 windsurf.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "windsurf.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 windsurf.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".windsurf.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 chatgpt.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "chatgpt.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 chatgpt.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".chatgpt.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 openai.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "openai.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 openai.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".openai.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 oaistatic.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "oaistatic.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 oaistatic.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".oaistatic.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 oaiusercontent.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      "oaiusercontent.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：域名 oaiusercontent.com 的子域 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
      ".oaiusercontent.com": [
        "https://1.1.1.1/dns-query#AI",
        "https://8.8.8.8/dns-query#AI"
      ],
      // 配置说明：精确域名 copilot.microsoft.com 使用下列解析器；Mihomo 地址尾部 #名称 指定解析连接策略。
  ...
  "defaults": {
    // 配置说明：业务分类「节点选择」的公共配置项。
    "节点选择": "DIRECT",
    // 配置说明：业务分类「GitHub」的公共配置项。
    "GitHub": "DIRECT"
  },
  // 配置说明：业务分类「lazyAutomatic」的公共配置项。
  "lazyAutomatic": true
};
...
function tuneMihomo(config) {
  ...
  // 来源前缀只用于识别订阅，不限制普通组或 AI 组的候选。
  // 兼容已应用旧版“花云专供 AI”的输入，只撤销本仓库生成的来源排除项。
  const legacySourceExcludes = ["^【花云】", "^【(?!花云】)[^】]+】"];
  function originalExclude(value) {
    if (!value) return "";
    for (const marker of legacySourceExcludes) {
  ...
  for (const group of config["proxy-groups"]) {
    ...
    if (!group["exclude-filter"]) continue;
    const exclude = originalExclude(group["exclude-filter"]);
    if (exclude) group["exclude-filter"] = exclude;
    else delete group["exclude-filter"];
  }
...
// 配置说明：客户端覆写入口：接收现有配置并返回合并结果；后续步骤可能由客户端再次合并。
function main(config) {
  return tuneMihomo(consolidateGroups(applyEnvironment(applySharedConfig(applyNodeServerAliases(config)), ENVIRONMENT), false));
}
